...
village. Having lived in a big city, he ﬁ nds the forests, fresh 
air, sounds of gushing streams, and chirping birds a novel 
experience.
However, for Keshav, the most fascinating sight is the 
dance of hundreds of ﬁ reﬂ ies at night, ﬂ ashing their lights 
in a wonderful performance. Jatin’s grandparents explain 
that ﬁ reﬂ ies are seasonal insects and they use light to 
communicate. Unfortunately, Keshav also learns the number 
of ﬁ reﬂ ies is decreasing due to light pollution, reduced forest 
...
beams from the headlights of passing vehicles ﬂ ashing by. He 
...
our solar system shine only by reﬂ ecting the light of the 
Sun? Is moonlight just reﬂ ected sunlight? Which objects give 
...
of natural light on the Earth. Stars, lightning, natural ﬁ re, and 
certain animals also emit their own light (Fig. 11.1).
In ancient times, humans learnt to create 
ﬁ re — the earliest form of artiﬁ cial lighting. With 
time, they learnt to create 
ﬁ re using diﬀ erent fuels, 
such as animal fat, oil, 
wax, and gas (Fig. 11.2). 
With the invention of 
electricity and diﬀ erent 
...
own light. It just reﬂ ects the light emitted 
...
Indian government has made substantial eﬀ orts to 
...
ob
object. It 
ust reﬂ ects the lig
at falls on it.
Some sources of electric light
...
===== SOURCE PAGE 3 =====
Light: Shadows and Reﬂ ections 
155
11.2 Does Light Travel in a Straight Line?
g
g
Let us do an activity to try to ﬁ nd out.
...
(a)
(b)
Fig. 11.5: Viewing candle ﬂ ame through 
...
diﬀ erent materials in the path of 
light and ﬁ nd out.
Activity 11.3: Let us experiment
Collect objects made of diﬀ erent materials. Also, you will 
need a torch.
Tracing paper
Table 11.1: Light through diﬀ erent materials
Light will pass 
...
pointer is suﬃ  cient. Never point the laser beam directly at 
anyone’s eyes, as it can cause serious eye damage.
Pass 
a 
laser 
beam 
through a beaker ﬁ lled with 
...
Also, you might have had fun making diﬀ erent shapes with 
shadows sometime.  
...
Collect some opaque objects of diﬀ erent shapes and sizes. 
Repeat Activity 11.3, but this time, carry out the actions 
mentioned in the ﬁ rst column of Table 11.2.
...
keeping the torch and the screen ﬁ xed.
...
Light: Shadows and Reﬂ ections 
159
to observe a shadow. The walls, ﬂ oor, ground, or any other surface 
...
form, ﬂ at cut-out ﬁ gures called 
...
to life. Diﬀ erent regions have their 
...
Find a shiny ﬂ at steel plate or a plane mirror, that is, a mirror 
that is ﬂ at and not curved. 
...
light by a mirror is called the reﬂ ection of light. Let us try to 
understand the reﬂ ection of light by a mirror.
Activity 11.6: Let us experiment
Fig. 11.8: Using mirror to redirect 
sunlight on a wall
Turn the shiny plate or mirror in 
diﬀ erent directions to redirect the 
...
on the mirror. The reﬂ ection of light occurs at the 
mirror.
mirror.
...
reﬂ ection of light?
(a)
Fig. 11.9: (a) A light beam (b) Reﬂ ection 
...
a reﬂ ection of your face in the mirror. We also see reﬂ ections of 
other objects that are in front of the mirror. Let us try to ﬁ nd out 
more about this.
...
Now, move the pen to diﬀ erent positions in front of the 
...
Again, move the pen to diﬀ erent positions in front of the 
...
mirror?
Stand at diﬀ erent distances from the mirror and notice how 
far the image appears to be from the mirror in each case. 
Do you ﬁ nd any relation between your distance from the 
mirror and the distance of your image from the mirror?
Fig. 11.10: Image of a pen 
in a plane mirror
Fig. 11.11: Observing one’s 
...
You ﬁ nd that your left appears right in your image and your 
...
reﬂ ected by mirrors, it is time to create some useful items based 
on this learning.
11.8.1 Periscope
...
strips of thick reﬂ ective paper instead 
of mirrors. Fix these in a circular tube 
of thick chart paper (Fig. 11.15b). On 
one end of the tube, ﬁ x a transparent 
...
to see a diﬀ erent pattern every time the kaleidoscope is turned 
about. Since there are 3 mirrors, and multiple images (due to 
reﬂ ections of reﬂ ections), many interesting patterns are formed. 
...
a ﬁ xed torch as shown in Fig. 11.18. 
...
ﬂ ame through the pipe as shown in 
Fig. 11.16. Who can see the ﬂ ame?
...
diﬀ erence do you notice? Explain the reason for 
the diﬀ erence.
...
used to make a periscope? If yes, mark where 
you will ﬁ x the plane mirrors. 
12. We do not see the shadow on the ground of a bird ﬂ ying high 
in the sky. However, the shadow is seen on the ground when 
the bird swoops near the ground. Think and explain why it 
is so.
Exploratory Projects
Have you ever seen a ﬁ reﬂ y where you live? If no, ask your 
elders if ﬁ reﬂ ies were seen earlier in your region. If yes, ﬁ nd 
...
Curiosity | Textbook of Science | Grade 7
168
the shadow. Repeat this using transparent paper of diﬀ erent 
