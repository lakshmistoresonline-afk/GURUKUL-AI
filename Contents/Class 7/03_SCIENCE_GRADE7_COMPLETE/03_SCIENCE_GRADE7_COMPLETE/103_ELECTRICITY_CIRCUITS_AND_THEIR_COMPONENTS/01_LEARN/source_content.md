...
followed by their neighbourhood, their city, and ﬁ nally they 
searched the internet. To their astonishment, their list kept 
growing. They decided to organise the uses under diﬀ erent 
headings.
Entertainment
Television, 
radio, 
...
torch lamp glows and in the other position the lamp does not 
glow.
...
p
To understand how a torch works, let us ﬁ rst ﬁ nd out about its 
components.
3.2.1 Electric cell
...
ﬂ at metal disc on the other side?
...
Put the cells back in a diﬀ erent order. Also, try reversing 
...
has 
a 
diﬀ erent kind of lamp. In fact, it 
cannot be taken out of the torch 
as it is ﬁ xed in it. 
(b)
...
still use such lamps. With your teacher’s help, conﬁ rm 
that your torchlight uses an incandescent lamp.
Take the torch and examine its lamp. What do you 
see? Do you notice a thin wire ﬁ xed in the middle 
of the glass bulb? 
Now, switch on the torch. Which part of the lamp 
glows? 
The thin wire inside the glass bulb of the lamp glows. 
The glowing thin wire is called the ﬁ lament of the lamp. 
Take out the lamp with the help of your teacher and 
inspect it from all sides. How is the ﬁ lament ﬁ xed?
The ﬁ lament is attached to two thicker wires that 
...
are ﬁ xed in a way that they do not touch each other. 
In such incandescent lamps, the ﬁ lament gets hot and 
...
observe. Do you see any ﬁ lament inside it?
Notice the length of two wires attached to 
the LED. Do you ﬁ nd one of those longer 
than the other?
Unlike incandescent lamps, LEDs do not 
have ﬁ laments (Fig. 3.6). They also have two 
...
LEDs, sometimes of diﬀ erent shapes, in its 
lamp.
...
cell holder is not available, ﬁ x the two wires to the cell using 
...
the circuit is complete and current flows through 
the filament.
Fascinating facts
...
that can fit two cells (Fig. 3.10a), and two lengths of electric 
wire.
...
positive terminal wire to the longer wire of 
...
in the ﬁ rst case (Fig. 3.10c) and does not glow in 
...
it glows. Always take care to connect an LED 
...
Curiosity | Textbook of Science | Grade 7
32
Fig. 3.12: An electrical 
circuit with a switch in 
(a) ‘OFF’ position  
(b) ‘ON’ position
(a)
(b)
...
(a)
(b)
How does a switch turn 
on or off the torchlight?
...
 Insert a drawing pin through the ring of the 
...
position (Fig. 3.12b) where the circuit is closed 
...
(Fig. 3.12a), we say that the circuit is open.
Note that a switch can be placed anywhere in 
a circuit. A switch is a simple device that either 
completes or breaks a circuit. The switches used 
for lights and other devices at home work the 
same way, though they are designed differently.
3.2.6 Electric switch
Let us first make a simple 
switch on our own.
Reprint 2026-27
...
g
The various components of an electrical 
circuit can be represented by symbols 
shown in Table 3.2.
Can we represent 
the circuits in a 
simpler manner?
...
or 
rubber?
Fig. 3.13: Positive and negative 
...
can flow. The two arrows indicate that an 
LED emits light (Fig. 3.13b).
By 
using 
symbols 
to 
...
leaving the two ends of wires free as shown 
in Fig. 3.15a. 
...
Collect objects of diﬀ erent materials, such 
as metal spoons, coins, cork, rubber, glass, 
keys, pins, plastic scale, wooden block, 
aluminium foil, candle, sewing needle, 
cardboard, paper, and pencil lead.
One by one, touch the free ends of the tester’s 
...
8.
9.
Fig. 3.15: (a) Conduction tester 
(b) Using the conduction tester for 
testing a material
(b)
(a)
Reprint 2026-27
...
can ﬂ ow easily are called good conductors, or conductors of 
...
making wires. 
Silver, copper, and gold are the best electrical conductors. 
However, for making electrical wires, mainly copper is used 
due to its comparatively lower cost and abundant supply. 
Diﬀ erent types of electrical wires are used for diﬀ erent uses.
mak
DIVE
EEPER
...
Have you ever wondered how the electricity from a cell or 
battery is diﬀ erent from the electricity coming from a wall 
...
the ﬁ lament, which gets hot and glows to produce light when 
...
Materials through which electric current can ﬂ ow easily are 
called good conductors or conductors of electricity.
...
Curiosity | Textbook of Science | Grade 7
38
3. In Fig. 3.17, if the ﬁ lament of one of the lamps is broken, will 
...
electric components.
6. In Fig. 3.18: 
(i) If S2 is in ‘ON’ position, S1 is in ‘OFF’ position, which 
lamp(s) will glow?
(ii) If S2 is in ‘OFF’ position, S1 is in ‘ON’ position, which 
lamp(s) will glow?
(iii) If S1 and S2 both are in ‘ON’ position, which lamp(s) will 
glow?
...
will you do to ﬁ nd out why the 
lamp did not glow?
Fig. 3.19
INNOVATION
EXPLORATION
...
Electricity: Circuits and their Components
39
8.	 In Fig. 3.20, in which case(s) the lamp/LED will not glow when 
...
that are working.
11.	 Using an LED that requires two cells in series to glow, Tanya 
made the circuit as shown in Fig. 3.21. Will the lamp glow? If 
not, draw the wires for correct connections.
Fig. 3.21
+
–
...
each cell, also ﬁ nd out which device(s) it is used for. Prepare 
a report.
...
for diﬀ erent purposes, such as cylindrical 
