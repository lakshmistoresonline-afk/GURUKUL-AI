...
Exploring Society: India and Beyond  
India and the World: Land and the People
experienced the first two while navigating the map in 
Fig. 1.1. Let us now define them more precisely.
Have you ever wondered how a huge place can fit on a 
small piece of paper? It is all thanks to the map’s scale. 
Let us go back to our map of a small city (Fig. 1.1). Each 
centimetre on the map represents a certain distance on 
the ground — let us suppose it is 500 metres; we say that 
...
every 24 hours. A full turn is 360°, so this means 15° per hour 
(15 × 24 = 360). Let us now mark the meridians of longitude 
every 15°. Moving eastward from the Prime Meridian, we 
get 0°, 15°E, 30°E, 45°E, and so on every 15° up to 180°E. 
It is the same as adding one hour of local time with each 
15° meridian — if it is 12 pm or noon at Greenwich, it is 
1 pm local time at 15°E, 2 pm at 30°E, and so on. But going 
