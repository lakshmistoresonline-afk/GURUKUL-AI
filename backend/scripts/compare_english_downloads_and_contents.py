...
dl_dir = r"C:\Users\srina\Downloads\Class 5\English"
ct_dir = r"D:\GURUKUL\Contents\Class 5\English"

print("==========================================================================")
print("DEEP FORENSIC COMPARISON OF ENGLISH JSON FILES")
print("==========================================================================\n")

for fname in ["Master.json", "Notes.json", "Flashcards.json", "Mindmaps.json", "Quiz.json"]:
