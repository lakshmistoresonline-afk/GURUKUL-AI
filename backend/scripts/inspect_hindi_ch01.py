...
data = json.load(open('D:/GURUKUL/Contents/Class 5/Hindi/Hindi Master.json', encoding='utf-8'))
ch1 = data['chapters_master_data'][0]

print("=== HINDI CHAPTER 1 KEYS & PAYLOADS ===")
